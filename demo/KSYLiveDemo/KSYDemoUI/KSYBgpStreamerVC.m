...
- (void)setupUI{
    ...
    // top view
    selectFileBtn = [ctrlView addButton:@"Select the background image"];//选择背景图片
    ...
    // bottom view
    captureBtn = [ctrlView addButton:@"Start Previewing"];
    streamBtn = [ctrlView addButton:@"Start Streaming"];
